...
MODEL_PATH = 'cotton_plant_detection_model.pt' 
OUTPUT_DIR = 'video_results'
VIDEO_PATH = 'fce4d5da363dc5fab047ba5932832572-720p-preview_Kn4vbDVH.mp4'
...
CLASS_COLORS = {
    'G-arboreum': (255, 0, 0),        # Blue
    'G-barbadense': (0, 255, 0),      # Green
    'G-herbaceum': (0, 0, 255),        # Red
    'G-hirsitum': (255, 255, 0) # Cyan
}
