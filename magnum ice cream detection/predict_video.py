...
MODEL_PATH = 'magnum_ice_cream_detection_model.pt'
...
CLASS_COLORS = {
    'magnum ice cream wrapped': (255, 0, 255),   # Magenta
    'magnum with chocolate coating': (0, 255, 0),   # Red
    'magnum without chocolate coating': (0, 0, 255),   # Green
    'megnum box packed': (255, 0, 0)   # Blue
}
