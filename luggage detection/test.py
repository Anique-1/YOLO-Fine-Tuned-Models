...
MODEL_PATH = 'handbag_clutch_schoolbag_detection_model.pt'  # or 'teeth_detection_model.pt' if that's your latest
TEST_IMAGES_DIR = 'dataset_1/test/images'
OUTPUT_DIR = 'test_results_1'
