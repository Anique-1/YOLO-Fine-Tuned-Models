...
MODEL_PATH = 'road_line_detection_model.pt'  # segmentation-only model
OUTPUT_DIR = 'video_results'
VIDEO_PATH = 'Driving Into the Sun Video - Trim.mp4'  # Set your video path here

# Class names and colors (from dataset/data.yaml)
CLASS_NAMES = ['lane', 'road']
